...
fn bundled_steel_resource_is_valid_and_has_declared_asset_integrity() {
    ...
    assert_eq!(
        ...
        vec![
            ...
            "steel.search_literature".to_string(),
            "steel.read_literature_section".to_string(),
            "steel.query_production_data".to_string(),
            "steel.query_composition_standard".to_string(),
            "steel.query_process_standard".to_string(),
            "steel.ask_llm_with_context".to_string(),
            "steel.get_model_status".to_string(),
            "steel.predict_performance".to_string(),
            "steel.optimize_process".to_string(),
            "steel.match_coil".to_string(),
            "steel.start_training".to_string(),
            "steel.process_literature".to_string(),
            "steel.export_data".to_string(),
            "steel.remember_memory".to_string(),
            "steel.read_memory".to_string(),
            "steel.search_memory".to_string(),
            "steel.list_memory".to_string(),
            "steel.forget_memory".to_string(),
        ]
    );
