...
const MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        version: 21,
        sql: include_str!("migrations/0021_database_connections.sql"),
    },
    Migration {
        version: 22,
        sql: include_str!("migrations/0022_task_timings.sql"),
    },
    Migration {
        version: 23,
    ...
    Migration {
        version: 27,
        sql: include_str!("migrations/0027_task_claims.sql"),
    },
    Migration {
        version: 28,
        sql: include_str!("migrations/0028_agent_checkpoints.sql"),
    },
    Migration {
        version: 29,
        sql: include_str!("migrations/0029_agent_turn_snapshots.sql"),
    },
    Migration {
        version: 30,
