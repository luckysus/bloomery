use super::model::{
    LocalLlmConfig, StreamedLlmAnswer, LOCAL_SUMMARY_CONTEXT_CHAR_LIMIT,
...
pub fn build_summary_prompt(query: &str, contexts: &[String]) -> String {
    let compacted = contexts
        .iter()
        .take(LOCAL_SUMMARY_CONTEXT_LIMIT)
