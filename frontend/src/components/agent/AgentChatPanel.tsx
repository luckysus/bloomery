...
export default function AgentChatPanel({
  ...
  return (
    <section className="flex-1 min-h-0 overflow-hidden bg-[#fbf7ef]">
      <div className="h-full flex flex-col">
        <div ref={messagesRef} className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden px-6 pt-5 space-y-3 max-md:px-3">
