...
function ConversationMenu({
  ...
  return (
    <div className="absolute right-2 top-8 z-30 w-44 rounded-xl border border-slate-200 bg-white p-1.5 shadow-xl shadow-slate-900/10">
      ...
      <button
        ...
        className="flex h-9 w-full items-center gap-3 rounded-lg px-3 text-sm font-medium text-red-600 transition-colors hover:bg-red-50"
      >
        <Trash2 size={16} />
        删除
      </button>
...
function MenuButton({
  ...
  return (
    <button
      onClick={onClick}
      className="flex h-9 w-full items-center gap-3 rounded-lg px-3 text-sm font-medium text-slate-700 transition-colors hover:bg-slate-100"
    >
      {icon}
      {children}
    </button>
